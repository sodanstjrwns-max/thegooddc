...
import { breadcrumbSchema, faqSchema, citySchema, speakableSchema, qaPageSchema } from '../lib/seo'
    ...
    >
      ...
      <section class="sec">
        <div class="container article-body">
          ...
          <p class="aeo-answer">
            <strong class="aeo-tldr">한줄답:</strong> {CLINIC.name}는 {CLINIC.address}에 위치해 {area.desc} 지역에서 가까운 거리에 있습니다.
          ...
          <div class="related-box">
            <h3><i class="fa-solid fa-circle-info" style="color:var(--brand);margin-right:8px"></i>{area.name}에서 오시는 길 · 진료시간</h3>
            ...
            <p style="margin:0 0 14px;color:var(--ink-soft)"><strong>버스:</strong> {[...CLINIC.directions.bus.general, ...CLINIC.directions.bus.seat, ...CLINIC.directions.bus.express].join(', ')}</p>
            <p style="margin:0 0 14px;color:var(--ink-soft)"><strong>진료시간:</strong> 평일 09:00-18:00(월·수 야간 20:00), 토 08:00-12:00 · {CLINIC.hoursNote}</p>
            <div class="chip-row">
