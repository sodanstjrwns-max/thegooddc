...
const HOME_FAQS = [
  ...
  { q: '어떤 진료를 받을 수 있나요?', a: '디지털 가이드 임플란트, 투명교정, 스마일 크라운·라미네이트 심미치료를 비롯해 통합치의학과 전반의 진료를 제공합니다.' },
]
...
const MARQUEE = [
  '디지털 가이드 임플란트', '투명교정', '스마일 크라운', '원내 기공실', '편안한 마취 시스템',
...
export const HomePage: FC<{ popup?: Notice | null }> = ({ popup }) => {
  ...
  return (
    <Layout
      title="더착한치과 | 강서구 명지 임플란트·투명교정·스마일 크라운 치과"
